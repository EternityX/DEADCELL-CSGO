    ...
    private:
      ...
      static simple_json::JSON to_json_object(const Boxed_Value &t_bv)
      {
        try {
		  ...
		  simple_json::JSON obj(simple_json::JSON::Class::Object);
          for (const auto &o : m)
          {
        ...
        try {
		  ...
		  simple_json::JSON obj(simple_json::JSON::Class::Array);
        ...
        try {
          ...
          if (Boxed_Number::is_floating_point(t_bv))
          {
            ...
            return simple_json::JSON(bn.get_as<std::int64_t>());
          }
        ...
        if (t_bv.is_null()) return simple_json::JSON(); // a null value
