...
struct CCSGOPlayerAnimState {
	...
	float eyeAngles_y; //0x0078 
	float eyeAngles_x; //0x007C 
	float m_flGoalFeetYaw; //0x0080 
	float m_flCurrentFeetYaw; //0x0084 
	float m_flTorsoYaw; //0x0088 
	float m_flLastMoveYaw; //0x008C 
	...
	float m_fDuckAmount; //0x00A4 
	float m_fLandingDuckAmount; //0x00A8 
